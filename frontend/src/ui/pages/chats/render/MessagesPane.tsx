...
export interface MessagesPaneCtx {
  ...
  insertMarkdownIntoComposer: any
  isMobile: any
              ...
              <div style={{ position: 'relative', flex: 1, minWidth: 0, display: 'flex' }}>
                ...
                <div
                  ...
                  onPaste={(e) => {
                    ...
                    if (hasText) {
                      // Сначала пробуем разобрать разметку: вставленный кусок с
                      // «**жирным**», заголовками, списками и таблицами должен лечь в
                      // поле уже форматированным — иначе при отправке звёздочки
                      // экранируются и собеседник видит палки. Обычный текст (без
                      // разметки) вставляется как раньше, буква в букву.
                      if (insertMarkdownIntoComposer(text) || insertPlainTextIntoComposer(text)) {
                        e.preventDefault()
