...
export function CallOverlay({ open, conversationId, onClose, onMinimize, minimized = false, initialVideo = false, initialAudio = true, peerAvatarUrl = null, avatarsByName = {}, avatarsById = {}, localUserId = null, isGroup = false }: Props) {
  ...
  const videoContainCss = `
    ...
    /* LiveKit hides connection quality until hover; keep it always visible so the ring is always visible */
    .call-container .lk-participant-tile .lk-connection-quality {
      opacity: 1 !important;
      transition-delay: 0s !important;
    }

    /* Connection-quality ring (0..100), injected into LiveKit's quality slot. */
    .call-container .lk-connection-quality.eb-q {
    ...
    /* When we have a score, hide LiveKit's stock quality icon and show our ring. */
    .call-container .eb-q.eb-q-has-value > svg:not(.eb-q-ring) { display: none !important; }
    .call-container svg.eb-q-ring { width: 26px; height: 26px; overflow: visible; display: none; }
    .call-container .eb-q.eb-q-has-value svg.eb-q-ring { display: block; }
    .call-container svg.eb-q-ring .eb-q-track { fill: none; stroke: rgba(255, 255, 255, 0.18); stroke-width: 4; }
    .call-container svg.eb-q-ring .eb-q-arc {
      fill: none;
      stroke-width: 4;
      stroke-linecap: round;
      transition: stroke-dashoffset 0.6s ease, stroke 0.6s ease;
    }
    .call-container svg.eb-q-ring .eb-q-text {
