...
function flashGroup(selector: string): void {
  ...
  tag.textContent = ''
  /*
   * Подсвечиваем ТОЛЬКО нужные, ничего не затемняя.
   *
   * Пробовал наоборот — гасить всё остальное. На экране это читается
   * наизнанку: глаз видит потемневшую галерею и понимает её как «всё
   * выключили», а не «вот эти выбраны», тем более что найденная группа часто
